  ...
  const returnBlobVariant = () => {
    switch (blobSize) {
      ...
      default:
        return (
          <>
            <div className="absolute top-0 bg-violet-500 rounded-full w-96 h-96 -left-2 mix4nd-multiply filter blur-xl opacity-70 animate-blob"></div>
            <div className="absolute top-0 bg-cyan-500 rounded-full w-96 h-96 -right-2 mix4nd-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
